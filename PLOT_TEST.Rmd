...
x <- runif(100)
y <- runif(100)
plot(x, y, xlab="X", ylab="Y") # type="n" hides the points
lines(c(0,1), c(0, 1))
...
# left
mtext("Line0", side=2, line=0, adj=0, cex=1, col="purple")
mtext("Line1", side=2, line=1, adj=0, cex=1, col="purple")
mtext("Line2", side=2, line=2, adj=0, cex=1, col="purple")
mtext("Line3", side=2, line=3, adj=0, cex=1, col="purple")
mtext("Line0.5", side=2, line=0.5, adj=1, cex=1, col="purple")
mtext("Line1.5", side=2, line=1.5, adj=1, cex=1, col="purple")
mtext("Line2.5", side=2, line=2.5, adj=1, cex=1, col="purple")
# right
mtext("Line0", side=4, line=0, adj=0.5, cex=1, col="purple")
mtext("Line1", side=4, line=1, adj=0.5, cex=1, col="purple")
mtext("Line2", side=4, line=2, adj=0.5, cex=1, col="purple")
mtext("Line3", side=4, line=3, adj=0.5, cex=1, col="purple")
